        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight">
              ...
              <Typewriter
                ...
                typeSpeed={75}
                words={[
                    "Experience Campus Life at Its Best!",
                    "Your Home Away from Home on Campus!",
                    "Discover Comfort and Convenience in Our Hostels!",
                    "Welcome to Your University Residence!",
                    "Your Academic Journey Starts Here!",
                    "Where Learning and Living Go Hand in Hand!",
                    "Find Your Place in the Heart of Campus!",
                    "Enjoy Student Living at Its Finest!",
                    "Live, Learn, and Grow in Our Hostel Community!",
                    "Your Gateway to University Adventures!",
                ]}
              />
            </h1>
            <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">
              &quot;Where Every Meal is a Study Break!&quot;
            </p>
            <div>
              <label
            ...
            <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
              ...
              <div className="py-5">
                <div className="flex space-x-1">
                  ...
                  <span className="text-gray-800">Study Break</span>
                </div>
                <p className="mt-2 text-gray-800 dark:text-gray-400">
          ...
          <div>
            <img
              ...
              src="https://i.ibb.co/zRMFzbD/Home-Banner.jpg"
              alt="Hero Image"
            />
          </div>
        </div>
